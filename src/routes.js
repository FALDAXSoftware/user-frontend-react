...
class AppRouter extends Component {
  ...
  _onIdle(e) {
    ...
    console.log('last active', moment.unix(this.idleTimer.getLastActiveTime()).format("MM/DD/YYYY"))
  }
  render() {
...
function mapStateToProps(state, ownProps) {
  return ({
    ...
    isLoggedIn: state.simpleReducer.isLoggedIn !== undefined ? state.simpleReducer.isLoggedIn : false,
