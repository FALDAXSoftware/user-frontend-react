                ...
                <WhiteBgWrapper>
                  <div>
                    <Headwrap>
                      <Row>
                        <Col span={24}>
                          <RiseText style={{ marginBottom: "0" }}>
                            {this.t("market:crypto_screener.message")}
                          </RiseText>
                        </Col>
                      </Row>
                      <Row>
                        <Col span={24} style={{ marginBottom: "20px" }}>
                          <Tabs
                            defaultActiveKey="1"
                            onChange={this.onScreenerTabChange}
                            tabBarExtraContent={
                              <Tooltip title="Launch In Fullscreen">
                                <Button
                                  className="fullscreenBtn"
                                  size={"large"}
                                  type="link"
                                  onClick={() => {
                                    this.goFullScreen("screener");
                                  }}
                                >
                          ...
                          >
                            <TabPane
                              tab={this.t("market:overview.message")}
                              key="1"
                            ...
                            <TabPane
                              tab={this.t("market:performance.message")}
                              key="2"
                            >
                            ...
                            <TabPane
                              tab={this.t("market:oscillators.message")}
                              key="3"
                            >
                            ...
                            <TabPane
                              tab={this.t("market:trend_following.message")}
                              key="4"
                            >
                  ...
                  <div>
                    <Headwrap>
                      <Row style={{}}>
                        <Col span={24}>
                          <RiseText>
                            {this.t("market:rise_fall.message")}
                          </RiseText>
                        </Col>
                      </Row>
                      <Row>
