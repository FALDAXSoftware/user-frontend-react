...
const CustomSelect = styled(Select)`
    ...
    background-color:${props => (props.theme.mode === "dark" ? "#041b2c" : "white")};
      font-size: 16px;
      font-family: "Open sans";
      color: ${props =>props.theme.mode === "dark" ? "#617090 !important" : "rgba( 0, 0, 0, 0.231 )"};
      font-weight: bold;
      line-height: 1.125;
      text-align: left;
      border:none;
            ...
            <div style={{width:"100%",padding:"12.5px"}}>
                <Row style={{marginBottom:"10px"}}>
                    <Col>
                        ...
                        <CustomSelect value={this.state.selectedPair} onChange={this.onChange}>
                            {
                                this.props.pairs.map(el=>(
                                    <Select.Option value={el.name.split("-").join("")}>{el.name}</Select.Option>
