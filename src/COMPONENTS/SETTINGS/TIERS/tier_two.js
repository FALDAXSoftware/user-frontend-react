...
import { notification, Icon, Steps } from "antd";
import styled from "styled-components";

/* components */
import { kycDoc, kycFormAction } from "ACTIONS/SETTINGS/passwordActions";
import { ButtonWrap, SubWrap, BackButton, NextButton } from "../KYC/id_select";
// Styled components
import {
  TierInnerWrap,
  TierCommonHead,
              ...
              <TierStepContent>
                {current === 0 && (
                  <div>
                    <SSNWrap>
                      <SSNSub>
                        <SSNlabel>Upload Your Proof Of Residence</SSNlabel>
                      </SSNSub>
                      <Filewrap>
