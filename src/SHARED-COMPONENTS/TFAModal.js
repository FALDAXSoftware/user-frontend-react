...
/* STYLED-COMPONENTS */
import { VerifyModal, Description, NewP, InputLabel, OTPInput, ButtonDiv, NewButton } from 'COMPONENTS/SETTINGS/changePassword/change_email.js'
    ...
    render() {
        ...
        return (
            <VerifyModal
                ...
                footer={null}
            >
                <Description> Please enter your Two-Factor Authentication Code to continue.</Description>
                <NewP>
                    ...
                    <div>
                        ...
                        {this.validator.message('verification code', fields['otp'], 'required|numeric')}
                    </div>
                </NewP>
                <ButtonDiv>
