...
class ComingSoon extends Component {
    ...
    render() {
        return (
            <div>
                <Modal
                    title={<div><img alt="FALDAX" src={_COMINGIMG} /> <img alt="FALDAX" style={{ marginLeft: "10px" }} src={_COMINGIMG2} /></div>}
                ...
                >
                    <ModalWrap>
                        <h3 style={{ fontFamily: "Open Sans", fontSize: "40px", textAlign: "center", color: "rgb(3, 170, 249)", fontWeight: "600", marginTop: "40px" }}>KYC not done.</h3>
                        <p style={{ fontFamily: "Open Sans", fontSize: "28px", textAlign: "center", color: "black", fontWeight: "600", marginTop: "40px" }}>Please complete KYC to check if trading is allowed in your country or not.</p>
                        {/* <Sub_wrap>
